...
public class MovieDto {
    ...
    public MovieDto(String movie_name, String watch_hours, String movie_actor_name, byte[] movie_photo, String fileType, String released_date, String movie_description) {
